...
@Composable
fun PlantDetailDescription(plantDetailVM: PlantDetailViewModel) {
    val plant by plantDetailVM.plant.observeAsState()
...
private fun PlantDescription(desc: String){
    //rememembers HTML formatted desc, reexecutes on new desc
